    ...
    <div className="recipe-meta-badge">
      ...
      {icon === 'tag' && (
        <svg xmlns="http://www.w3.org/2000/svg" width="22" height="22" fill="none" viewBox="0 0 22 22">
          <circle cx="11" cy="11" r="11" fill="none" fillOpacity=".4" className="recipe-icon-badge--fill" />
          <circle cx="11" cy="11" r="10.5" stroke="none" strokeOpacity=".68" className="recipe-icon-badge--path" />
          <path 
